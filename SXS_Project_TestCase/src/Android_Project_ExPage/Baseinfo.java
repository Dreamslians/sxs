...
public class Baseinfo
{
    ...
    public static final String AndroidDriverURL = "http://192.168.1.50:4723/wd/hub";
    ...
    public static final String AndroidappDir = "sxs_android_v1.2.2.2_2016-11-29.apk";
    ...
    //************************登录页面操作所需值************************
    public static final String LoginTelephoneNumber = "17301216033";
    ...
    public static final String AssLoginPageByInUseID = "SELECT vault_user_auth.inuse FROM vault_user_auth,vault_user WHERE vault_user.id=vault_user_auth.user_id AND moblie='17301216033'";
    //************************************************************************************************
    ...
    public static final String ChangeLoginPWTelephoneNumber = "17301216003";
    ...
    public static final String AssChangeLoginPWByInUseID = "SELECT vault_user_auth.inuse FROM vault_user_auth,vault_user WHERE vault_user.id=vault_user_auth.user_id AND moblie='17301216003'";
    //************************************************************************************************
    ...
    //************************忘记密码页面操作所需值************************
    public static final String ForgotPasswordTelephone = "17600110001";
    public static final String ForgotPasswordNewPassword = "qqqqqq";
    public static final String ForgotPasswordAgainPassword = "qqqqqq";
    public static final String GetVerifyByForgetPW = "SELECT verify FROM vault_user_moblie_verify WHERE moblie='17600110001' ORDER BY id DESC LIMIT 1;";
    //************************************************************************************************
    ...
    public static final String CheckUpdateTelephone = "17600110001";
    public static final String CheckUpdatePassword = "qqqqqq";
    public static final String AssCheckUpdateByInUseID = "SELECT vault_user_auth.inuse FROM vault_user_auth,vault_user WHERE vault_user.id=vault_user_auth.user_id AND moblie='17301216033'";
    //************************************************************************************************

    //************************更改绑定手机号页面操作所需值（ChangeBildingPage）************************
    public static final String ChangeBildingTelephone = "17600110006";
    public static final String GetVerifyByBildingPageOne = "SELECT verify FROM vault_user_moblie_verify WHERE moblie='17600110006' ORDER BY id DESC LIMIT 1;";
    public static final String ChangeBildingPassword = "qqqqqq";
    public static final String ChangeBildingNewTelephone = "17600110007";
    public static final String GetVerifyByBildingPageTwo = "SELECT verify FROM vault_user_moblie_verify WHERE moblie='17600110007' ORDER BY id DESC LIMIT 1;";
    public static final String AssChangeBildingByInUseID = "SELECT vault_user_auth.inuse FROM vault_user_auth,vault_user WHERE vault_user.id=vault_user_auth.user_id AND moblie='17600110001'";
    //************************************************************************************************

    //***********************首页投资页面操作所需值***********************
    public static final String InvestTelephone = "17301216033";
    public static final String InvestPassword = "qqqqqq";
    public static final String InvestMoney = "1000";
    public static final String AssInvestByInUseID = "SELECT vault_user_auth.inuse FROM vault_user_auth,vault_user WHERE vault_user.id=vault_user_auth.user_id AND moblie='17301216033'";
    //************************************************************************************************

    //***********************发现页面操作元素所需值（FoundPage）******************************
    public static final String FoundPageLoginTelePhone = "17301216033";
    public static final String FoundPagePassword = "qqqqqq";
    public static final String AssFoundPageByInUseID = "SELECT vault_user_auth.inuse FROM vault_user_auth,vault_user WHERE vault_user.id=vault_user_auth.user_id AND moblie='17301216033'";
    //************************************************************************************************

    //***********************支付密码页面操作所需值***********************
    public static final String PayPWTelephone= "17301216033";
    public static final String PayPWPassword= "qqqqqq";
    public static final String GetVerifyByFindPayPW = "SELECT verify FROM vault_user_moblie_verify WHERE moblie='17301216033' ORDER BY id DESC LIMIT 1;";
    public static final String AssPayPWByInUseID = "SELECT vault_user_auth.inuse FROM vault_user_auth,vault_user WHERE vault_user.id=vault_user_auth.user_id AND moblie='17301216033'";
    //************************************************************************************************


    //************************关于我们页面操作元素所需值（AboutUSPage）*************************
    public static final String AboutUSPageTelephone = "17301216033";
    public static final String AboutUSPagePassword = "qqqqqq";
    public static final String AssAboutUSByInUseID = "SELECT vault_user_auth.inuse FROM vault_user_auth,vault_user WHERE vault_user.id=vault_user_auth.user_id AND moblie='17301216033'";
    //************************************************************************************************
