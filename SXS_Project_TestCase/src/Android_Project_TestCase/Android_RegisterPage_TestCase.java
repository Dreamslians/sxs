    ...
    public void doRegister() throws Exception {
        ...
        try {
            ...
            Assert.assertEquals("我的资产",
                    Android_LoadDevice_NotReset.driver.findElement(ar.ao.getLocaator("SettingPageTittle")).getText());
    ...
    public void doRegisterFailByVerifyCode() throws Exception {
        try {
            ...
            Assert.assertEquals("请输入验证码",
                    Android_LoadDevice_NotReset.driver.findElement(ar.ao.getLocaator("RegisterPageVerify")).getText());
        }catch (Exception e){
            Android_LoadDevice_NotReset.driver.closeApp();
            Android_LoadDevice_NotReset.driver.launchApp();
            po.doLoginOutByResetApp();
    ...
    public void doRegisterFailByTelephoneAndVerifyCode() throws Exception {
        try {
            ...
            Assert.assertEquals("请输入手机号码",
                    Android_LoadDevice_NotReset.driver.findElement(ar.ao.getLocaator("RegisterPageTelephone")).getText());
        }catch (Exception e){
            Android_LoadDevice_NotReset.driver.closeApp();
            Android_LoadDevice_NotReset.driver.launchApp();
            po.doLoginOutByResetApp();
