...
public class Android_CheckUpdatePage
{
	...
	public void doSettingPageVersionUpdate() throws Exception {
		Android_LoadDevice_NotReset.driver.findElement(ao.getLocaator("SettingPageVersionUpdate")).click();
	}

	public void doSettingPageVersionUpdateSure() throws Exception {
		Android_LoadDevice_NotReset.driver.findElement(ao.getLocaator("SettingPageVersionUpdateSure")).click();
	}

	public void doSettingPageVersionUpdateSureUpdate() throws Exception {
		Android_LoadDevice_NotReset.driver.findElement(ao.getLocaator("SettingPageVersionUpdateSureUpdate")).click();
	}
	...
	public void doCheckUpdateByHaveUpdate() throws Exception {
		...
		Assert.assertEquals("立即更新",
				Android_LoadDevice_NotReset.driver.findElement(ao.getLocaator("SettingPageVersionUpdateSureUpdate")).getText());
