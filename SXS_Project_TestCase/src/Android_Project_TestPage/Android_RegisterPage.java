...
public class Android_RegisterPage
{
	...
	public void doRegisterPageTelephone(String Telephone) throws Exception {
		Android_LoadDevice_NotReset.driver.findElement(ao.getLocaator("RegisterPageTelephone")).clear();
		Android_LoadDevice_NotReset.driver.findElement(ao.getLocaator("RegisterPageTelephone")).sendKeys(Telephone);
	}

	// 获取验证码
	public void doRegisterPageRegisterCode() throws Exception {
		Android_LoadDevice_NotReset.driver.findElement(ao.getLocaator("RegisterPageRegisterCode")).click();
	}

	// 输入验证码
	public void doRegisterPageRegisterCodeText(String RegisterCode) throws Exception {
		Android_LoadDevice_NotReset.driver.findElement(ao.getLocaator("RegisterPageRegisterCodeText")).clear();
		Android_LoadDevice_NotReset.driver.findElement(ao.getLocaator("RegisterPageRegisterCodeText"))
				.sendKeys(RegisterCode);
	}

	// 点击“我同意”按钮
	public void doRegisterPageAgreeButton() throws Exception {
		Android_LoadDevice_NotReset.driver.findElement(ao.getLocaator("RegisterPageAgreeButton")).click();
	}

	// 读取协议
	public void doRegisterPageRegisterText() throws Exception {
		Android_LoadDevice_NotReset.driver.findElement(ao.getLocaator("RegisterPageRegisterText")).click();
	}

	// 从协议返回
	public void doRegisterPageRegisterTextReturnButton() throws Exception {
		Android_LoadDevice_NotReset.driver.findElement(ao.getLocaator("RegisterPageRegisterTextReturnButton")).click();
	}

	// 点击注册按钮
	public void doRegisterPageRegisterButton() throws Exception {
		Android_LoadDevice_NotReset.driver.findElement(ao.getLocaator("RegisterPageRegisterButton")).click();
	}

	// 输入图文验证码
	public void doRegisterPageVerifyCode(String VerifyCode) throws Exception {
		Android_LoadDevice_NotReset.driver.findElement(ao.getLocaator("RegisterPageVerifyCode")).sendKeys(VerifyCode);
	}

	// 从注册页面点击登录
	public void doRegisterPageLoginButton() throws Exception {
		Android_LoadDevice_NotReset.driver.findElement(ao.getLocaator("RegisterPageLoginButton")).click();
	}

	public void doRegisterPagePassWord(String PassWord) throws Exception {
		Android_LoadDevice_NotReset.driver.findElement(ao.getLocaator("RegisterPagePassWord")).clear();
		Android_LoadDevice_NotReset.driver.findElement(ao.getLocaator("RegisterPagePassWord")).sendKeys(PassWord);
	}

	public void doRegisterPageNewPassWord(String NewPassWord) throws Exception {
		Android_LoadDevice_NotReset.driver.findElement(ao.getLocaator("RegisterPageNewPassWord")).clear();
		Android_LoadDevice_NotReset.driver.findElement(ao.getLocaator("RegisterPageNewPassWord")).sendKeys(NewPassWord);
	}

	public void doRegisterPageButton() throws Exception {
		Android_LoadDevice_NotReset.driver.findElement(ao.getLocaator("RegisterPageButton")).click();
	}

	public void doRegisterPageJump() throws Exception {
		Android_LoadDevice_NotReset.driver.findElement(ao.getLocaator("RegisterPageJump")).click();
	}
